  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
        ...
        <button
          className="bg-transparent border-2 border-white text-white px-6 py-2 rounded-lg hover:bg-white hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 transition duration-150 ease-in-out"
        ...
        {/* Filter & Sort Section */}
        <div className="bg-white shadow-lg rounded-lg mt-10 mx-auto max-w-5xl  z-10 p-3 lg:p-3">
