      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <NavLink to="/" className="block">Our Rooms</NavLink>
            <NavLink to="/about" className="block">About</NavLink>
            <NavLink to="/contact" className="block">Contact</NavLink>
          </div>
          <div className="pt-2 pb-3 border-t border-gray-200">
            <div className="flex items-center px-5 space-x-2">
              <Link to='/login' className="block px-3 py-1 rounded text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Sign In</Link>
              <Link to='/register' className="block px-3 py-1 rounded text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Sign Up</Link>
            </div>
          </div>
        </div>
      )}
