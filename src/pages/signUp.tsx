        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 p-6 space-y-3 md:space-y-4">
            ...
            <form className="space-y-4 md:space-y-4" onSubmit={handleSubmit}>
              ...
              />
              {err.email && (
                <p className="text-xs text-red-500 -mt-2">{err.email}</p>
              )}
              <Input
                type="text"
                label="Number"
              ...
              />
              {err.number && (
                <p className="text-xs text-red-500 -mt-2">{err.number}</p>
              )}
              <Input
                type="password"
                label="Password"
              ...
              />
              {err.password && (
                <p className="text-xs text-red-500 -mt-2">{err.password}</p>
              )}
              <Input
                type="password"
              ...
              />
              {err.repassword && (
                <p className="text-xs text-red-500 -mt-2">{err.repassword}</p>
              )}
              ...
              <div className="flex justify-center items-center gap-2">
                ...
                <Link
                  to="/login"
                  className="text-xs md:text-sm text-[#EA454C] font-semibold"
                >
                  Log in
                </Link>
              </div>
