...
function yourRooms() {
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Mobile:</span> {room.mobile}
                    </p>
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Slots:</span> {room.slots}
                    </p>
                    <p className="text-sm text-gray-600">
                    ...
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Gender:</span> {room.gender}
                    </p>
                    <p className="text-sm text-gray-600">
  ...
  {room.isAproved === true ? (
    <Link to={`/editRoom/${room._id}`}>
      <Button color="danger" className="ml-auto">Edit</Button>
    </Link>
  ) : (
    <Button
      isLoading
